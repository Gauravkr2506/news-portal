  ...
  return (
    <div className={styles.page}>
      <div className={styles.hero}>
        ...
        <h1 className={styles.title}>India&apos;s Voice for News That Matters</h1>
        <p className={styles.lead}>
          NewsEdition is an independent digital news platform delivering accurate, timely coverage
          of business, politics, and every major story shaping India and the world. We believe
          that an informed citizen is an empowered citizen.
        </p>
      </div>
      ...
      <div className={styles.stats}>
        ...
        <div className={styles.stat}>
          ...
          <div className={styles.statLabel}>India-first</div>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.body}>
          <p>
            NewsEdition was founded with a clear purpose — to make quality journalism accessible
            to every Indian. We focus primarily on business and politics, the forces that shape
            economies and lives, while ensuring no important story from any domain goes unreported.
          </p>
          <p>
            We are committed to factual, unbiased reporting. Every story published goes through
            editorial review to ensure accuracy and balance. We believe the press exists to inform,
      ...
      <div className={styles.section}>
        ...
        <div className={styles.teamCard}>
          ...
          <div>
            <div className={styles.teamName}>Amit Gautam</div>
            <div className={styles.teamRole}>Founder &amp; Editor-in-Chief</div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.social}>
          ...
          <span className={styles.socialDead} title="LinkedIn — coming soon">
            {LINKEDIN_ICON}
            LinkedIn
          </span>
        </div>
